"""Broker adapters for normalized FortiOS driver operations."""
...
from netsage.drivers.fortios import FortiOSDriver
from netsage.models import Capability, CommandResult
from netsage.policies import OperationClass


class FortiOSToolSet:
    """Register structured tools backed by an explicit device-to-driver map."""

    def __init__(self, drivers: Mapping[str, FortiOSDriver]) -> None:
    ...
    def _driver(self, arguments: Mapping[str, object]) -> FortiOSDriver:
        ...
        try:
            ...
            raise ValueError("No FortiOS driver is registered for device") from error
